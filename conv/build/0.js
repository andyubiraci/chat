...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chat_room__ = __webpack_require__(318);
...
var ChatRoomPage = (function () {
    function ChatRoomPage(navCtrl, navParams, socket, toastCtrl) {
        ...
        this.getUsers().subscribe(function (data) {
            var user = data['user'];
            if (data['event'] === 'left') {
                _this.showToast(user + ', se desconecto');
            }
            else {
                _this.showToast(user + 'en línea');
            }
        });
    }
